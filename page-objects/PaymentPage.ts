...
export class PaymentPage{
    //Define Selectors
    readonly page:Page
    readonly payeeSelectionBox:Locator
    ...
    constructor(page:Page){
        this.page=page
        this.payeeSelectionBox=page.locator('#sp_payee')
    ...
    async createPayment(){
        await this.payeeSelectionBox.selectOption('apple')
        ...
        await this.dateInput.type('2022-18-10')
        await this.descriptionInput.type('Some message display')
